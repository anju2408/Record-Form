...
function DoneVitalSigns() {
    ...
    document.getElementById('pbodytemptesting').innerText = " " + bodytemptesting + ' ';
...
function complaintimage() {
    ...
    function captureSnapshot() {
        ...
        if (null != cameraStream) {
            ...
            var img = new Image();
            ctx.drawImage(streamcomplaints, 0, 0, capturecomplaint.width, capturecomplaint.height);
...
function summaryimage() {
    ...
    function captureSnapshot() {
        ...
        if (null != cameraStream) {
            ...
            ctx.drawImage(streamsummary, 0, 0, capturesummary.width, capturesummary.height);
...
function observationimage() {
    ...
    function captureSnapshot() {
        ...
        if (null != cameraStream) {
            ...
            ctx.drawImage(streamobservation, 0, 0, captureobservation.width, captureobservation.height);
...
function daignosesimage() {
    ...
    function captureSnapshot() {
        ...
        if (null != cameraStream) {
            ...
            ctx.drawImage(streamdaignoses, 0, 0, capturedaignoses.width, capturedaignoses.height);
...
$(document).ready(function() {
    ...
    $('#addrow').on('click', function() {
        ...
        cols += "<td class='col-sm-1'><p></p><input type='number' name='Sr.no' class='form-control'" + counter + "/></td>";

        cols += "<td class='col-sm-2'><p></p><input type='text' name='type'  class='form-control'" + counter + "/></td>";

        cols += "<td class='col-sm-6'><p></p><input type='text' name='drugname'  class='form-control' style='font-size:large;' placeholder='Name of Tablet'" + counter + "/><p><input type='text' name='compositon' class='form-control' placeholder='composition of tablet' style='font-size: smaller;'></p></td>";

        cols += "<td class='col-sm-4'><p><select name='' id='' class='oral'><option value='Oral'>Oral</option><option value='injection'>injection</option><option value='saline'>saline</option></select></p></td>";

        var colst = "<td class='dosagef'><p><input type='text'></p>";

        var colsd = "<div class='tables'>Tablet(s)</div>";

        var colf = "<p><select name='' id='' class='presopt'><option value='Twice Daily'>Twice Daily</option><option value='Thrice Daily'>Thrice Daily</option><option value='At night'>At night</option>";

        var colopt = "<option value='Once Morning'>Once Morning</option><option value='as needed'>as needed</option><option value='once a week'>once a week</option><option value='Four times a day'>Four times a day</option>";

        var coloptn = "<option value='twice a week'>twice a week</option><option value='every other day'>every other day</option><option value='every other hour'>every other hour</option><option value='every four hours'>every four hours</option><option value='every 2 hours'>every 2 hours</option></select></p></td>";

        cols += colst + colsd + colf + colopt + coloptn;

        cols += "<td class='col-sm-2'><p><select name='' id=''><option value='After Food'>After Food</option><option value='Before Food'>Before Food</option></select></p></td>";

        cols += "<td><div class='duration'><p><input type='number'></p><p><select name='' id='' class='daysd'><option value='Day(s)'>Day(s)</option><option value='Week(s)'>Week(s)</option><option value='Month(s)'>Month(s)</option></select></p></div></td>"

        cols += "<td class='col-sm-1'><a class='deleteRow'><img src='https://img.icons8.com/material-outlined/24/ff0000/cancel--v1.png' id='crossoout' /></a></td>"
...
function setinsstamp() {
    ...
    var p1 = document.createElement('p');
    p1.innerText = "Need for Immunosuppression/DMARD therapy " + val + " adverse effects explained in Detail";
    document.getElementById('stamp1').appendChild(p1);
    var p2 = document.createElement('p');
    p2.innerText = "Nature of the disease, Prognosis and Need for Long Term Treatment is explained with its adverse effect and allergic reaction.";
...
function reveiw() {
    ...
    img4.src = "https://img.icons8.com/fluency-systems-regular/48/000000/edit--v1.png";
