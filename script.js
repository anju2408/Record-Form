...
function LoadSavedComments(picture) {
  console.log("function load saved called");
...
$("button[name='delete']").click(function() {
    ...
    // console.log(images);
    // console.log($("#imgContainer_" + iPosition));
    // $("#imgContainer_" + iPosition).remove();
...
uploadFilePopup = $("#uploadedfiles");

uploadFilePopup.click(function (e) {
  myWindow.data("kendoWindow").open();
  uploadFilePopup.fadeOut();
});
